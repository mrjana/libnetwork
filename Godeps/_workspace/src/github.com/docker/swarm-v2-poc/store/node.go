...
// to the logs
func NewRaftNode(id uint64, addr string, debug bool, appendEvent chan<- struct{}, handler Handler) *RaftNode {
...
// layer side
func (n *RaftNode) Ping(ctx context.Context, ping *PingRequest) (*Acknowledgment, error) {
...
// existing cluster
func (n *RaftNode) JoinCluster(ctx context.Context, info *NodeInfo) (*JoinClusterResponse, error) {
	nodes := []*NodeInfo{}
...
func (n *RaftNode) AddNode(ctx context.Context, info *NodeInfo) (*AddNodeResponse, error) {
	err := n.RegisterNode(info)
	if err != nil {
...
func (n *RaftNode) Send(ctx context.Context, message *raftpb.Message) (*Acknowledgment, error) {
